...
class DiscsControllerTest < ActionController::TestCase
  ...
  test "should create disc" do
    assert_difference('Disc.count') do
      post :create, disc: { artist_id: @disc.artist_id, fecha: @disc.fecha, genero: @disc.genero, titulo: @disc.titulo }
    end
  ...
  test "should update disc" do
    patch :update, id: @disc, disc: { artist_id: @disc.artist_id, fecha: @disc.fecha, genero: @disc.genero, titulo: @disc.titulo }
    assert_redirected_to disc_path(assigns(:disc))
  end
